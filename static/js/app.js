...
{
	if (!AppData.SingleMode && !App.Ajax.hasOpenedRequests())
	{
...
CPrefetcher.prototype.prefetchAccountQuota = function ()
{
	...
	if (!this.prefetchStarted() && AppData.App && AppData.App.ShowQuotaBar && !oAccount.quotaRecieved())
	{
...
function CMessageModel()
{
	...
	/*setInterval(_.bind(function () {
		 if (this.uid() == '1191') {
		 console.log('---------------------');
		 console.log(this.threadsAllowed());
		 console.log(this.threadCount());
		 console.log(this.threadLoading());
		 console.log(this.partialFlagged());
		 }
	 }, this), 3000);*/
