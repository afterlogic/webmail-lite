...
!function(){function t(t){function n(){if(o&&t>a){var e=o,r=e[0],u=Array.prototype.slice.call(e,1),c=e.index;o=o===i?i=null:o.next,++a,u.push(function(t,e){--a,p||(t?l&&d(p=t,l=s=o=i=null):(s[c]=e,--l?n():d(null,s)))}),r.apply(null,u)}}var o,i,r={},a=0,l=0,u=-1,p=null,s=[],d=e;return arguments.length<1&&(t=1/0),r.defer=function(){if(!p){var t=arguments;t.index=++u,i?(i.next=t,i=i.next):o=i=t,++l,n()}return r},r.await=function(t){return d=t,l||d(p,s),r},r}function e(){}"undefined"==typeof module?self.queue=t:module.exports=t,t.version="0.0.2"}(),function(t,e,n){"use strict";function o(t){return"undefined"==typeof t}function i(t,e){if(e)for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t}function r(t,e){var n=!1;return t&&e&&(n=t===e?!0:t.contains?t.contains(e):e.compareDocumentPosition?!!(8&e.compareDocumentPosition(t)):!1),n}function a(t){t>0&&clearTimeout(t),t=0}function l(t){return t=t&&(t.originalEvent?t.originalEvent:t)||e.event,t.dataTransfer?t:null}function u(t,e,n){return t&&e&&!o(t[e])?t[e]:n}function p(t,e,n){t[e]=n}function s(t){return t&&t.length&&0<t.length?!0:!1}function d(t){return parseInt(t||0,10)}function c(t,e){return function(){return t.apply(o(e)?null:e,Array.prototype.slice.call(arguments))}}function f(t){var e="",n="0123456789abcdefghijklmnopqrstuvwxyz";for(t=o(t)?32:d(t);e.length<t;)e+=n.substr(Math.round(Math.random()*n.length),1);return e}function h(){return"jua-uid-"+f(16)+"-"+(new Date).getTime().toString()}function m(t,e){var n=o(t.fileName)?o(t.name)?null:t.name:t.fileName,i=o(t.fileSize)?o(t.size)?null:t.size:t.fileSize,r=o(t.type)?null:t.type;return{FileName:n,Size:i,Type:r,Folder:o(e)?"":e,File:t}}function D(t,e,n,i,r,a){var l=0,u=0,p=0,c=null,f=null,h=!1,D=!1,v=function(t,e,n,u){if(t&&!o(t.name))if(e=e||"",t.isFile)t.file(function(t){!h||0<=--r?n(m(t,e)):h&&!D&&0>r&&a&&(D=!0,a(l))});else if(i&&t.isDirectory&&t.createReader){var p=t.createReader(),d=0,c=0;p&&p.readEntries&&p.readEntries(function(o){if(o&&s(o))for(d=0,c=o.length;c>d;d++)v(o[d],e+t.name+"/",n,u)})}};if(i=o(i)?!0:!!i,n=o(n)?!1:!!n,r=o(r)?w:d(r),l=r,h=r>0,t=t&&0<t.length?t:null)for(p=0,u=t.length;u>p;p++)c=t[p],c&&(n?"file"===c.kind&&c.webkitGetAsEntry&&(f=c.webkitGetAsEntry(),f&&v(f,"",e,a)):!h||0<=--r?e(m(c)):h&&!D&&0>r&&a&&(D=!0,a(l)))}function v(t,e,n,o){var i=t&&t.files&&0<t.files.length?t.files:null;i?D(i,e,!1,!1,n,o):e({FileName:t.value.split("\\").pop().split("/").pop(),Size:null,Type:null,Folder:"",File:null})}function g(t){var e=!1;if(t&&t.dataTransfer&&t.dataTransfer.types&&t.dataTransfer.types.length)for(var n=0,o=t.dataTransfer.types.length;o>n;n++)if("files"===t.dataTransfer.types[n].toLowerCase()){e=!0;break}return e}function y(t,e,n,o,i){var r=null,a=null;t=l(t),t&&(r=(t.dataTransfer?u(t.dataTransfer,"items",null):null)||u(t,"items",null),r&&0<r.length&&r[0]&&r[0].webkitGetAsEntry?D(r,e,!0,i,n,o):g(t)&&(a=u(t,"files",null)||(t.dataTransfer?u(t.dataTransfer,"files",null):null),a&&0<a.length&&D(a,e,!1,!1,n,o)))}function E(){return t('<label style="position: absolute; background-color:#fff; right: 0px; top: 0px; left: 0px; bottom: 0px; margin: 0px; padding: 0px; cursor: pointer;"></label>').css({opacity:0})}function b(){return t('<input type="file" tabindex="-1" hidefocus="hidefocus" style="position: absolute; left: -9999px;" />')}function T(t,e){t=o(t)?"":t.toString();var n=b();return 0<t.length&&n.attr("name",t),(o(e)?!0:e)&&n.prop("multiple",!0),n}function S(e,n){return t.isFunction(e)?e.apply(null,t.isArray(n)?n:[]).toString():e.toString()}function A(t,e){this.oXhrs={},this.oUids={},this.oJua=t,this.oOptions=e}function O(t,e){this.oUids={},this.oForms={},this.oJua=t,this.oOptions=e}function F(e){e=o(e)?{}:e;var s=this;s.bEnableDnD=!0,s.oEvents={onDialog:null,onSelect:null,onStart:null,onComplete:null,onCompleteAll:null,onProgress:null,onDragEnter:null,onDragLeave:null,onDrop:null,onBodyDragEnter:null,onBodyDragLeave:null,onLimitReached:null},s.oOptions=i({action:"",name:"",hidden:{},queueSize:10,clickElement:!1,dragAndDropElement:!1,dragAndDropBodyElement:!1,disableAjaxUpload:!1,disableFolderDragAndDrop:!0,disableDragAndDrop:!1,disableMultiple:!1,disableDocumentDropPrevent:!1,disableAutoUploadOnDrop:!1,multipleSizeLimit:50},e),s.oQueue=n(d(u(s.oOptions,"queueSize",10))),s.runEvent("onCompleteAll")&&s.oQueue.await(function(){s.runEvent("onCompleteAll")}),s.oDriver=s.isAjaxUploaderSupported()&&!u(s.oOptions,"disableAjaxUpload",!1)?new A(s,s.oOptions):new O(s,s.oOptions),s.oClickElement=u(s.oOptions,"clickElement",null),s.oClickElement&&(t(s.oClickElement).css({position:"relative",overflow:"hidden"}),"inline"===t(this.oClickElement).css("display")&&t(this.oClickElement).css("display","inline-block"),this.oDriver.generateNewInput(this.oClickElement)),this.oDriver.isDragAndDropSupported()&&u(this.oOptions,"dragAndDropElement",!1)&&!u(this.oOptions,"disableAjaxUpload",!1)?!function(e){var n=t(document),o=t(u(e.oOptions,"dragAndDropBodyElement",!1)||n),i=u(e.oOptions,"dragAndDropElement",!1),p=function(t){if(e.bEnableDnD&&t&&(t=l(t),t&&t.dataTransfer&&g(t)))try{var n=t.dataTransfer.effectAllowed;a(e.iDocTimer),t.dataTransfer.dropEffect="move"===n||"linkMove"===n?"move":"copy",t.stopPropagation(),t.preventDefault(),o.trigger("dragover",t)}catch(i){}},s=function(t){e.bEnableDnD&&t&&(t=l(t),t&&g(t)&&(t.preventDefault(),y(t,function(n){n&&(u(e.oOptions,"disableAutoUploadOnDrop",!1)?e.runEvent("onDrop",[n,t,function(){e.addNewFile(n),a(e.iDocTimer)}]):(e.runEvent("onDrop",[n,t]),e.addNewFile(n),a(e.iDocTimer)))},u(e.oOptions,"multipleSizeLimit",w),e.getEvent("onLimitReached"),!u(e.oOptions,"disableFolderDragAndDrop",!0)))),e.runEvent("onDragLeave",[t])},d=function(t){e.bEnableDnD&&t&&(t=l(t),t&&g(t)&&(a(e.iDocTimer),t.preventDefault(),e.runEvent("onDragEnter",[i,t])))},c=function(t){if(e.bEnableDnD&&t){if(t=l(t)){var n=document.elementFromPoint?document.elementFromPoint(t.clientX,t.clientY):null;if(n&&r(this,n))return;a(e.iDocTimer),e.runEvent("onDragLeave",[i,t])}}else;};i&&(u(e.oOptions,"disableDocumentDropPrevent",!1)||n.on("dragover",function(t){if(e.bEnableDnD&&t&&(t=l(t),t&&t.dataTransfer&&g(t)))try{t.dataTransfer.dropEffect="none",t.preventDefault()}catch(n){}}),o&&o[0]&&o.on("dragover",function(t){e.bEnableDnD&&t&&a(e.iDocTimer)}).on("dragenter",function(t){e.bEnableDnD&&t&&(t=l(t),t&&g(t)&&(a(e.iDocTimer),t.preventDefault(),e.runEvent("onBodyDragEnter",[t])))}).on("dragleave",function(t){e.bEnableDnD&&t&&(t=l(t),t&&(a(e.iDocTimer),e.iDocTimer=setTimeout(function(){e.runEvent("onBodyDragLeave",[t])},200)))}).on("drop",function(t){if(e.bEnableDnD&&t&&(t=l(t))){var n=g(t);return n&&t.preventDefault(),e.runEvent("onBodyDragLeave",[t]),!n}return!1}),t(i).bind("dragenter",d).bind("dragover",p).bind("dragleave",c).bind("drop",s))}(s):s.bEnableDnD=!1,p(s,"on",s.on),p(s,"cancel",s.cancel),p(s,"isDragAndDropSupported",s.isDragAndDropSupported),p(s,"isAjaxUploaderSupported",s.isAjaxUploaderSupported),p(s,"setDragAndDropEnabledStatus",s.setDragAndDropEnabledStatus)}var w=20,x=function(){var t=document.createElement("input");return t.type="file",!!("XMLHttpRequest"in e&&"multiple"in t&&"FormData"in e&&(new XMLHttpRequest).upload)}();A.prototype.oXhrs={},A.prototype.oUids={},A.prototype.oJua=null,A.prototype.oOptions={},A.prototype.isDragAndDropSupported=function(){return!0},A.prototype.regTaskUid=function(t){this.oUids[t]=!0},A.prototype.uploadTask=function(e,n,i){if(!1===this.oUids[e]||!n||!n.File)return i(null,e),!1;try{var r=this,a=new XMLHttpRequest,l=new FormData,p=u(this.oOptions,"action",""),s=u(this.oOptions,"hidden",{}),d=this.oJua.getEvent("onStart"),c=this.oJua.getEvent("onComplete"),f=this.oJua.getEvent("onProgress");return a.open("POST",p,!0),f&&a.upload&&(a.upload.onprogress=function(t){t&&t.lengthComputable&&!o(t.loaded)&&!o(t.total)&&f(e,t.loaded,t.total)}),a.onreadystatechange=function(){if(4===a.readyState&&200===a.status){if(c){var n=!1,l=null;try{l=t.parseJSON(a.responseText),n=!0}catch(u){l=null}c(e,n,l)}o(r.oXhrs[e])||(r.oXhrs[e]=null),i(null,e)}else 4===a.readyState&&(c(e,!1,null),i(null,e))},d&&d(e),l.append("jua-post-type","ajax"),l.append(u(this.oOptions,"name","juaFile"),n.File),t.each(s,function(t,e){l.append(t,S(e,[n]))}),a.send(l),this.oXhrs[e]=a,!0}catch(h){}return i(null,e),!1},A.prototype.generateNewInput=function(e){var n=this,o=null,i=null;e&&(i=T("",!u(this.oOptions,"disableMultiple",!1)),o=E(),o.append(i),t(e).append(o),i.on("click",function(){var t=n.oJua.getEvent("onDialog");t&&t()}).on("change",function(){v(this,function(t){n.oJua.addNewFile(t),n.generateNewInput(e),setTimeout(function(){o.remove()},10)},u(n.oOptions,"multipleSizeLimit",w),n.oJua.getEvent("onLimitReached"))}))},A.prototype.cancel=function(t){if(this.oUids[t]=!1,this.oXhrs[t]){try{this.oXhrs[t].abort&&this.oXhrs[t].abort()}catch(e){}this.oXhrs[t]=null}},O.prototype.oUids={},O.prototype.oForms={},O.prototype.oJua=null,O.prototype.oOptions={},O.prototype.isDragAndDropSupported=function(){return!1},O.prototype.regTaskUid=function(t){this.oUids[t]=!0},O.prototype.uploadTask=function(n,o,i){if(!1===this.oUids[n])return i(null,n),!1;var r=this.oForms[n],a=u(this.oOptions,"hidden",{}),l=this.oJua.getEvent("onStart"),p=this.oJua.getEvent("onComplete");return r?(r.append(t('<input type="hidden" />').attr("name","jua-post-type").val("iframe")),t.each(a,function(e,n){r.append(t('<input type="hidden" />').attr("name",e).val(S(n,[o])))}),r.trigger("submit"),l&&l(n),r.find("iframe").on("load",function(){var o=!1,a=null,l={};if(p){try{a=this.contentDocument?this.contentDocument:this.contentWindow.document,l=t.parseJSON(a.body.innerHTML),o=!0}catch(u){l={}}p(n,o,l)}i(null,n),e.setTimeout(function(){r.remove()},100)})):i(null,n),!0},O.prototype.generateNewInput=function(e){var n=this,o="",i=null,r=null,a=u(this.oOptions,"action",""),l=null;e&&(o=h(),i=T(u(this.oOptions,"name","juaFile"),!u(this.oOptions,"disableMultiple",!1)),l=t('<form action="'+a+'" target="iframe-'+o+'"  method="POST" enctype="multipart/form-data" style="display: block; cursor: pointer;"></form>'),r=t('<iframe name="iframe-'+o+'" tabindex="-1" src="javascript:void(0);"  style="position: absolute; top: -1000px; left: -1000px; cursor: pointer;" />').css({opacity:0}),l.append(E().append(i)).append(r),t(e).append(l),this.oForms[o]=l,i.on("click",function(){var t=n.oJua.getEvent("onDialog");t&&t()}).on("change",function(){v(this,function(t){t&&(l.css({position:"absolute",top:-1e3,left:-1e3}),n.oJua.addFile(o,t),n.generateNewInput(e))},u(n.oOptions,"multipleSizeLimit",w),n.oJua.getEvent("onLimitReached"))}))},O.prototype.cancel=function(t){this.oUids[t]=!1,this.oForms[t]&&(this.oForms[t].remove(),this.oForms[t]=!1)},F.prototype.bEnableDnD=!0,F.prototype.iDocTimer=0,F.prototype.oOptions={},F.prototype.oEvents={},F.prototype.oQueue=null,F.prototype.oDriver=null,F.prototype.on=function(t,e){return this.oEvents[t]=e,this},F.prototype.runEvent=function(t,e){this.oEvents[t]&&this.oEvents[t].apply(null,e||[])},F.prototype.getEvent=function(t){return this.oEvents[t]||null},F.prototype.cancel=function(t){this.oDriver.cancel(t)},F.prototype.isAjaxUploaderSupported=function(){return x},F.prototype.setDragAndDropEnabledStatus=function(t){this.bEnableDnD=!!t},F.prototype.isDragAndDropSupported=function(){return this.oDriver.isDragAndDropSupported()},F.prototype.addNewFile=function(t){this.addFile(h(),t)},F.prototype.addFile=function(t,e){var n=this.getEvent("onSelect");!e||n&&!1===n(t,e)?this.oDriver.cancel(t):(this.oDriver.regTaskUid(t),this.oQueue.defer(c(this.oDriver.uploadTask,this.oDriver),t,e))},e.Jua=F}(jQuery,window,queue);
...
(function ($, window) {
	...
	Crea.prototype.start = function (bEditable)
	{
		...
		this.$editableArea.on('paste', function (oEvent) {
			...
			if (oEvent.clipboardData)
			{
				...
				else if (sHtml !== '')
				{
					...
					// *\r*\n fix for inserting single-line HTML text into the middle of the line (lost the second part of the line)
					sHtml = sHtml.replace(/<body([^>]*)>*\r*\n/gi, '<div$1>').replace(/<\/body>*\r*\n/gi, '</div>');
					sHtml = sHtml.replace(/<html[^>]*>*\r*\n/gi, '').replace(/<\/html>*\r*\n/gi, '');
					sHtml = sHtml.replace(/<!--StartFragment-->*\r*\n/gi, '').replace(/<!--EndFragment-->*\r*\n/gi, '');
		...
		this.$editableArea.on('keydown', function(oEvent) {
			...
			else if (!bAltKey && !bShiftKey && !oEvent.altKey && (iKey === Enums.Key.Space || iKey === Enums.Key.Enter))
			{
				self.editableSave();
			}
		});
