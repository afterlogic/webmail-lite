...
//	}, this);
	...
	this.fileListInfoText = ko.computed(function () {
		if (this.loading())
		{
            this.infoText = Utils.i18n('FILESTORAGE/INFO_LOADING');
		}
		else if (this.loadedFiles())
		{
			...
			if (this.collection().length === 0)
			{
				if (this.isPublic)
				{
					this.infoText = Utils.i18n('FILESTORAGE/INFO_PUBLIC_FOLDER_NOT_EXIST');
				}
				else
				{
					if (this.searchPattern() !== '' || this.isPublic)
					{
                        this.infoText = Utils.i18n('FILESTORAGE/INFO_NO_ITEMS_FOUND');
					}
					else
					{
						if (this.path() !== '' || this.isPopup)
						{
                            this.infoText = Utils.i18n('FILESTORAGE/INFO_FOLDER_IS_EMPY');
						}
						else
						{
                            this.infoText = Utils.i18n('FILESTORAGE/INFO_FILESTORAGE_IS_EMTY');
						}
					}
				}
			}
		...
		{
            this.infoText = Utils.i18n('FILESTORAGE/ERROR_FILESTORAGE');
		}
