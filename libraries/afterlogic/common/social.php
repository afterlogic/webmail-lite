...
//			@setcookie ("Social", "", time() - 1);
	...
	private static function _getTenant($sTenantHash)
	{
	...
	private static function _goToHelpdesk($sTenantHash)
	{
		if ($sTenantHash)
		{
	...
	private static function _socialError($oClient, $sSocialName)
	{
		$oClient->ResetAccessToken();
