...
class SharedItem{
	...
	public function getRootPath(){
		...
		return \CApi::DataPath() . '/' . Plugin::getPrivatePath() . '/' . $this->getOwner();
	...
	public function getItem()
	{
		...
		{
			return new SharedDirectory($this->authPlugin, $this->path, $this, true);
		}
		else
		{
			return new SharedFile($this->authPlugin, $this->path, $this, true);
		}
	}
